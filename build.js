...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  sockets: {
    ...
    resOrders: function resOrders(data) {
      console.log('resOrders', data);
      this.orders = data;
      //this.$eventBus.$emit('setOrders',data); 
    },
    resCommit: function resCommit(data) {
  ...
  methods: {
    restart: function restart() {
      window.location = 'http://view.torder.co.kr';
    },
    reqOrders: function reqOrders() {
      console.log('!!try reqOrders');
      this.orders = [];
      if (this.auth && this.auth.store && this.auth.store.code) {
        var reqData = { store_code: this.auth.store.code };
        console.log('reqOrders', reqData);
        this.$socket.emit('reqOrders', reqData);
      }
    },
    setStoreLength: function setStoreLength(length) {
    ...
    isSelectedStore: function isSelectedStore() {
  ...
  methods: {
    submit: function submit() {
      if (this.id && this.pw) {
        ...
        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('http://api.auth.order.orderhae.com/login', req_data).then(function (res) {
          if (res.data.length) {
            var data = res.data[0];
            var member = {
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    check: function check() {
      var auth = this.auth;
      if (auth && auth.member) {} else {
        this.$router.push('/member');
      }
    },
    selectStore: function selectStore(store, type) {
    ...
    getStores: function getStores() {
      if (this.auth && this.auth.member) {} else {
        return;
      }
      ...
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('http://api.auth.order.orderhae.com/stores', {
        params: req_data
      }).then(function (res) {
        if (res.data) {
          this.stores = [];
          ...
          try {
            for (var _iterator = res.data.store_data[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    current_amt: function current_amt() {
      var amt = 0;
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;
      ...
      try {
        for (var _iterator = this.tables[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
  ...
  methods: {
    ...
    getTablesInfo: function getTablesInfo() {
      var store_code = this.store.code;
      var req_data = {
        store_code: store_code
      };
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('http://api.auth.order.orderhae.com/tables', { params: req_data }).then(function (res) {
        console.log({ res: res });
        if (res.data) {
          this.tables = [];
          ...
          try {
            for (var _iterator2 = res.data.tables[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    reverse_orders: function reverse_orders() {
      return this.orders.sort(function (a, b) {
        return b.time - a.time;
      });
    },
    commited_orders_count: function commited_orders_count() {
      var count = 0;
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;
  ...
  methods: {
    setServiceStatus: function setServiceStatus(value) {
      this.serviceStatus = value;
      var url = 'http://admin.torder.co.kr/store/shop_open';
      if (!this.serviceStatus) {
        url = 'http://admin.torder.co.kr/store/shop_close';
      }
      var fd = new FormData();
      fd.append('store_code', this.auth.store.code);
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post(url, fd).then(function (res) {
        console.log(res);
      });
    },
    setOrderStatus: function setOrderStatus(value) {
      this.orderStatus = value;
      var url = 'http://admin.torder.co.kr/store/shop_open_order';
      if (!this.orderStatus) {
    ...
    setViewMode: function setViewMode(value) {
    ...
    newOrder: function newOrder(order) {
      this.scroll = false;
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    commitOrder: function commitOrder(order) {
    ...
    newOrder: function newOrder(order) {
      ...
      var code_group = this.order.group.code;
      var code_order = this.order.code;
      var cumulative_products = {};
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;
      ...
      try {
        for (var _iterator = this.orders[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          if (_order.group.code == code_group && _order.code != code_order) {
            var _iteratorNormalCompletion2 = true;
            var _didIteratorError2 = false;
            var _iteratorError2 = undefined;

            try {
              for (var _iterator2 = _order.products[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_cookies__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_filter__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_filter___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_vue_filter__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_socket_io__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vue_moment__ = __webpack_require__(30);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__OrderView_vue__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Member_vue__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__Store_vue__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__Table_vue__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__Logout_vue__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__OrderList_vue__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__OrderDetail_vue__ = __webpack_require__(72);
...
__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].use(__WEBPACK_IMPORTED_MODULE_3_vue_filter___default.a);
__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].use(__WEBPACK_IMPORTED_MODULE_5_vue_moment___default.a);
__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].use(new __WEBPACK_IMPORTED_MODULE_4_vue_socket_io___default.a({
  debug: true,
...
alert('test');
__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].prototype.$eventBus = new __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */]();

__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].component('order-detail', __WEBPACK_IMPORTED_MODULE_12__OrderDetail_vue__["a" /* default */]);
...
var routes = [{
  path: '/',
  component: __WEBPACK_IMPORTED_MODULE_6__OrderView_vue__["a" /* default */],
  children: [{
    path: 'member',
    name: 'member',
    component: __WEBPACK_IMPORTED_MODULE_7__Member_vue__["a" /* default */]
  }, {
    path: 'store',
    name: 'store',
    component: __WEBPACK_IMPORTED_MODULE_8__Store_vue__["a" /* default */]
  }, {
    path: 'table',
    name: 'table',
    component: __WEBPACK_IMPORTED_MODULE_9__Table_vue__["a" /* default */]
  }, {
    path: 'order',
    name: 'order',
    component: __WEBPACK_IMPORTED_MODULE_11__OrderList_vue__["a" /* default */]
  }, {
    path: 'logout',
    name: 'logout',
    component: __WEBPACK_IMPORTED_MODULE_10__Logout_vue__["a" /* default */]
  }]
}];
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(5), __webpack_require__(24).setImmediate))
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_OrderView_vue__ = __webpack_require__(7);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_c348fbae_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_OrderView_vue__ = __webpack_require__(51);
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_OrderView_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_c348fbae_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_OrderView_vue__["a" /* default */],
...
var update = __webpack_require__(2)("0f852b62", content, true, {});
...
// module
exports.push([module.i, "#orderview{display:flex;flex-direction:column;width:100vw;height:100vh;position:relative;background-color:#242424;font-family:NanumSquare,sans-serif}#orderview>.body{display:flex;flex-grow:1;overflow:auto}#orderview>.body .container{display:flex;flex-direction:column;padding:12px;flex-grow:1}#orderview>.body .container>*{display:flex}#orderview>.body .container>.top{display:flex;align-items:center;justify-content:center;border-bottom:1px solid #fff;padding-bottom:12px}#orderview>.body .container>.top .title{display:flex;align-items:center;justify-content:center;font-size:24px;font-weight:900}#orderview>.body .container>.bottom{margin-top:24px}#orderview>.body .container>.bottom .button{display:flex;margin:0;flex-grow:1;align-items:center;justify-content:center;height:60px;background-color:red;color:#fff;border-radius:100px;font-size:20px;font-weight:900}#orderview>.foot-left{display:flex;position:absolute;bottom:0;left:0}#orderview>.foot-right{display:flex;position:absolute;bottom:0;right:0}#orderview .button{display:flex;margin:12px 6px;height:40px;padding:0 24px;font-size:16px;font-weight:900;border-radius:200px;background-color:#eaeaea;color:#000;align-items:center;justify-content:center;text-decoration:none;box-shadow:0 0 12px -4px #000}#orderview .button-red{background-color:red;color:#fff}", ""]);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"orderview"}},[_c('div',{staticClass:"body"},[_c('router-view',{attrs:{"orders":_vm.orders,"auth":_vm.auth}})],1),_c('div',{staticClass:"foot-left"},[(_vm.auth.member)?_c('router-link',{staticClass:"button button-red",attrs:{"to":"/logout"}},[_vm._v(_vm._s(_vm.auth.member.name)+" 로그아웃")]):_vm._e(),(!_vm.auth.member)?_c('router-link',{staticClass:"button button-red",attrs:{"to":"/member"}},[_vm._v("로그인 ")]):_vm._e(),_c('div',{staticClass:"button",on:{"click":_vm.restart}},[_vm._v("재시작")])],1),_c('div',{staticClass:"foot-right"},[(_vm.storesLength>1)?_c('router-link',{staticClass:"button",attrs:{"to":"/store"}},[_vm._v("매장 보기")]):_vm._e(),(_vm.isStore)?_c('router-link',{staticClass:"button",attrs:{"to":"/order"}},[_vm._v("주문 보기")]):_vm._e()],1)])}
var staticRenderFns = []
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Member_vue__ = __webpack_require__(16);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_c5e75d0a_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_Member_vue__ = __webpack_require__(55);
function injectStyle (ssrContext) {
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_c5e75d0a_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_Member_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("ccb6ea3a", content, true, {});
...
// module
exports.push([module.i, ".body form{margin-top:24px;display:flex;flex-grow:1;flex-direction:column}.body form .input{display:flex;margin-bottom:24px}.body form .input input{display:flex;flex-grow:1;height:60px;border-radius:20px;border:1px solid #eaeaea;padding:0 16px;font-size:20px}.body form .input:last-child{margin-bottom:0}", ""]);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container"},[_vm._m(0),_c('div',{staticClass:"body"},[_c('form',{attrs:{"id":"login-form"}},[_c('div',{staticClass:"input"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.id),expression:"id"}],attrs:{"name":"id","type":"text","placeholder":"아이디"},domProps:{"value":(_vm.id)},on:{"input":function($event){if($event.target.composing){ return; }_vm.id=$event.target.value}}})]),_c('div',{staticClass:"input"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.pw),expression:"pw"}],attrs:{"name":"pw","type":"password","placeholder":"비밀번호"},domProps:{"value":(_vm.pw)},on:{"input":function($event){if($event.target.composing){ return; }_vm.pw=$event.target.value}}})])])]),_c('div',{staticClass:"bottom"},[_c('div',{staticClass:"button",on:{"click":_vm.submit}},[_vm._v("로그인하기")])])])}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"top"},[_c('div',{staticClass:"title"},[_vm._v("로그인을 해주세요.")])])}]
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Store_vue__ = __webpack_require__(17);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_15d34f2c_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_Store_vue__ = __webpack_require__(59);
function injectStyle (ssrContext) {
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_15d34f2c_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_Store_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("ded704ae", content, true, {});
...
// module
exports.push([module.i, "ul.store-list{display:flex;flex-grow:1;flex-direction:column;padding:0;margin:0;list-style:none;background-color:#272727}ul.store-list li.store-item{display:flex;align-items:center;flex-grow:1;flex-shrink:0;margin:0;padding:4px 24px;border-bottom:1px solid #484848;height:60px;color:#fafafa;font-size:20px;font-weight:900}ul.store-list li.store-item .name{flex-grow:1}ul.store-list li.store-item .order{display:flex}ul.store-list li.store-item .order>*{margin-left:16px}ul.store-list li.store-item .button{margin-left:24px;display:flex;align-items:center;justify-content:center;padding:0 24px;background-color:#fafafa;height:48px;border-radius:200px;color:#000;font-size:16px}", ""]);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container"},[_c('div',{staticClass:"top"},[_c('div',{staticClass:"title"},[_vm._v(_vm._s(_vm.auth.member?_vm.auth.member.name:''))])]),_c('div',{staticClass:"body"},[_c('ul',{staticClass:"store-list"},_vm._l((_vm.stores),function(store){return _c('li',{staticClass:"store-item",attrs:{"data-number":store.code}},[_c('div',{staticClass:"name"},[_vm._v(_vm._s(store.name))]),_c('div',{staticClass:"button button-order",on:{"click":function($event){return _vm.selectStore(store, "order")}}},[_vm._v("주문 보기")])])}),0)])])}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Table_vue__ = __webpack_require__(18);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_68fd11c2_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_Table_vue__ = __webpack_require__(63);
function injectStyle (ssrContext) {
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_68fd11c2_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_Table_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("fa4f45ac", content, true, {});
...
// module
exports.push([module.i, ".top .title,.top .title .name{display:flex;flex-grow:1}ul.table-list{display:flex;flex-wrap:wrap;margin:-12px;padding:0;list-style:none}ul.table-list li.table-item{display:flex;flex-direction:column;align-items:center;justify-content:center;flex-grow:1;margin:12px}ul.table-list li.table-item .name{display:flex;align-items:center;justify-content:center;border:2px solid #fff;border-radius:200px;font-size:20px;font-weight:700;min-width:3em}ul.table-list li.table-item .name:after{content:\"\";display:block;padding-top:100%}ul.table-list li.table-item .name.active{color:#fff;background-color:red;border-color:red}ul.table-list li.table-item .total-price{margin-top:4px;padding-top:4px;border-top:2px solid #fff;color:#fff}", ""]);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container"},[_c('div',{staticClass:"top"},[_c('div',{staticClass:"title"},[_c('div',{staticClass:"name"},[_vm._v(_vm._s(_vm.store.name)+" "+_vm._s(_vm._f("currency")(_vm.store.order_amt))+"원 "+_vm._s(_vm.store.order_cnt)+"개")]),_c('div',{staticClass:"table"},[_vm._v(_vm._s(_vm._f("currency")(_vm.current_amt))+"원")])])]),_c('div',{staticClass:"body"},[_c('ul',{staticClass:"table-list"},_vm._l((_vm.tables),function(table){return _c('li',{staticClass:"table-item",attrs:{"data-number":table.number}},[_c('div',{staticClass:"name",class:{'active':table.total_price}},[_vm._v(_vm._s(table.name))]),_c('div',{staticClass:"total-price"},[_vm._v(_vm._s(_vm._f("currency")(table.total_price))+"원")])])}),0)])])}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Logout_vue__ = __webpack_require__(19);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2e8b452a_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_Logout_vue__ = __webpack_require__(67);
function injectStyle (ssrContext) {
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2e8b452a_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_Logout_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("9075954c", content, true, {});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_OrderList_vue__ = __webpack_require__(20);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_8ab2d1f4_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_OrderList_vue__ = __webpack_require__(71);
function injectStyle (ssrContext) {
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_8ab2d1f4_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_OrderList_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("cebfb27e", content, true, {});
...
// module
exports.push([module.i, "#orders{display:flex;flex-direction:column;width:100%}#orders .top{display:flex;flex-shrink:0;height:40px;padding:12px;font-size:16px}#orders .top .tab-group{display:flex;flex-grow:1;height:40px}#orders .top .tab-name{display:flex;flex-grow:1;align-items:center;justify-content:center;font-weight:900;font-size:20px}#orders .top .tab-buttons{display:flex;flex-grow:1;margin:0;padding:0;height:100%;background-color:#000;border-radius:100px}#orders .top .tab-buttons .tab-button{display:flex;height:100%;flex-grow:1;align-items:center;justify-content:center;font-weight:900;background-color:#000;color:#fff}#orders .top .tab-buttons .tab-button .count{margin-left:8px;display:flex;align-items:center;justify-content:center;height:28px;padding:0 8px;background-color:#fff;color:#000;border-radius:100px;font-size:20px}#orders .top .tab-buttons .tab-button:first-child{border-top-left-radius:100px;border-bottom-left-radius:100px}#orders .top .tab-buttons .tab-button:last-child{border-top-right-radius:100px;border-bottom-right-radius:100px}#orders .top .tab-buttons .tab-button.active{background-color:#fafafa;color:#000;border-radius:100px}#orders .top .tab-buttons .tab-button.active .count{background-color:#000;color:#fafafa}#orders .order-list{display:flex;flex-direction:column;margin:0;padding:0 12px;overflow:scroll;-webkit-overflow-scrolling:touch}#orders .order-list .order-item{display:flex;flex-shrink:0;color:#fff;align-items:center;font-size:32px;font-weight:700;padding:8px 0;border-top:1px solid gray}#orders .order-list .order-item .table-number{display:flex;align-items:center;justify-content:center;background-color:red!important;border-radius:100px;padding:0;height:60px;color:#fff!important;font-size:44px;font-weight:700;line-height:1em;min-width:3em;margin-right:12px}#orders .order-list .order-item .msg{display:flex;align-items:center}#orders .order-list .order-item .msg .hof{margin-left:8px;height:32px;font-weight:900;padding:0 8px}#orders .order-list .order-item .first,#orders .order-list .order-item .msg .hof{display:flex;font-size:24px;border-radius:100px;align-items:center;background-color:#fff;color:#000}#orders .order-list .order-item .first{justify-content:center;height:40px;min-width:4em;margin-left:12px}#orders .order-list .order-item .commit{display:flex;align-items:center;justify-content:center;height:40px;min-width:4em;border-radius:100px;background-color:#fff;color:#000;font-size:24px;margin-left:auto;margin-right:12px}#orders .order-list .order-item .commit.commited{background-color:#000;color:#fff;border:2px solid #fff}#orders .order-list .order-item .time{text-align:right}#orders .order-list .order-item:first-child{border-top:none}#orders .order-list .order-item.commit{opacity:.5}#orders .scroll-stop{overflow:hidden!important;-webkit-overflow-scrolling:auto!important}", ""]);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"orders"}},[_c('order-detail',{attrs:{"orders":_vm.orders,"auth":_vm.auth}}),_c('div',{staticClass:"top"},[_c('div',{staticClass:"order-list-tab-buttons tab-buttons"},[_c('div',{staticClass:"order-list-tab-button tab-button",class:{active: _vm.viewMode=='a'},on:{"click":function($event){return _vm.setViewMode('a')}}},[_vm._v("모든 주문 보기"),_c('div',{staticClass:"count"},[_vm._v(_vm._s(_vm.orders.length))])]),_c('div',{staticClass:"order-list-tab-button tab-button",class:{active: _vm.viewMode=='n'},on:{"click":function($event){return _vm.setViewMode('n')}}},[_vm._v("미확인 주문 보기"),_c('div',{staticClass:"count"},[_vm._v(_vm._s(_vm.orders.length - _vm.commited_orders_count))])]),_c('div',{staticClass:"order-list-tab-button tab-button",class:{active: _vm.viewMode=='c'},on:{"click":function($event){return _vm.setViewMode('c')}}},[_vm._v("확인 주문 보기"),_c('div',{staticClass:"count"},[_vm._v(_vm._s(_vm.commited_orders_count))])])]),_c('div',{staticClass:"tab-group"},[_c('div',{staticClass:"tab-name"},[_vm._v("서비스")]),_c('div',{staticClass:"tab-buttons"},[_c('div',{staticClass:"tab-button",class:{active:_vm.serviceStatus},on:{"click":function($event){return _vm.setServiceStatus(1)}}},[_vm._v("켜기")]),_c('div',{staticClass:"tab-button",class:{active:!_vm.serviceStatus},on:{"click":function($event){return _vm.setServiceStatus(0)}}},[_vm._v("끄기")])])]),_c('div',{staticClass:"tab-group"},[_c('div',{staticClass:"tab-name"},[_vm._v("주문")]),_c('div',{staticClass:"tab-buttons"},[_c('div',{staticClass:"tab-button",class:{active:_vm.orderStatus},on:{"click":function($event){return _vm.setOrderStatus(1)}}},[_vm._v("켜기")]),_c('div',{staticClass:"tab-button",class:{active:!_vm.orderStatus},on:{"click":function($event){return _vm.setOrderStatus(0)}}},[_vm._v("끄기")])])])]),_c('ul',{staticClass:"order-list",class:{'scroll-stop': !_vm.scroll}},_vm._l((_vm.reverse_orders),function(order){return (_vm.viewMode=='a'||_vm.viewMode=='n'&&!order.commit.time||_vm.viewMode=='c'&&order.commit.time)?_c('li',{staticClass:"order-item order-title",class:{commit: order.commit.time, 'call-staff': order.call_staff, 'first-order': order.first_order},attrs:{"id":order.code},on:{"click":function($event){return _vm.newOrder(order)}}},[_c('div',{staticClass:"table-number"},[_vm._v(_vm._s(order.table.name))]),_c('div',{staticClass:"msg"},[(order.products[0].code=='99999')?_c('span',{staticClass:"title"},[_vm._v("호출이요")]):_c('span',{staticClass:"title"},[_vm._v("주문이요")])]),(order.group.seq==1)?_c('div',{staticClass:"first"},[_vm._v("첫 주문")]):_vm._e(),_c('div',{staticClass:"commit",class:{commited:order.commit.time}},[_vm._v(_vm._s(order.commit.time ? '확인' : '미확인'))]),_c('div',{staticClass:"time"},[_vm._v(_vm._s(_vm._f("moment")(order.time,"A hh:mm:ss")))])]):_vm._e()}),0)],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_OrderDetail_vue__ = __webpack_require__(21);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_8c39346c_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_OrderDetail_vue__ = __webpack_require__(75);
function injectStyle (ssrContext) {
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_OrderDetail_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_8c39346c_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_OrderDetail_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("7593b07c", content, true, {});
...
// module
exports.push([module.i, "#orderDetail{position:fixed;align-items:center;justify-content:center;z-index:101}#orderDetail,#orderDetail .background{top:0;left:0;display:flex;width:100%;height:100%}#orderDetail .background{position:absolute;z-index:102;background-color:rgba(0,0,0,.8)}#orderDetail .container{display:flex;padding:24px!important;flex-direction:column;align-items:center;justify-content:center;width:80%;height:80%;z-index:103;border:2px solid #fff;border-radius:24px;flex-grow:0!important;background-color:rgba(0,0,0,.9)}#orderDetail .container .container-top{display:flex;width:100%;flex-shrink:0}#orderDetail .container .container-top .order-title{width:100%;display:flex;flex-shrink:0;color:#fff;align-items:center;font-size:32px;font-weight:700;margin-bottom:12px}#orderDetail .container .container-top .order-title .table-number{display:flex;align-items:center;justify-content:center;background-color:red!important;border-radius:100px;padding:0;height:60px;color:#fff!important;font-size:44px;font-weight:700;line-height:1em;min-width:3em;margin-right:12px}#orderDetail .container .container-top .order-title .msg{display:flex;align-items:center}#orderDetail .container .container-top .order-title .msg .hof{margin-left:8px;display:flex;height:32px;font-size:24px;font-weight:900;padding:0 8px;border-radius:100px;align-items:center;background-color:#fff;color:#000}#orderDetail .container .container-top .order-title .first{margin-left:12px}#orderDetail .container .container-top .order-title .commit,#orderDetail .container .container-top .order-title .first{display:flex;align-items:center;justify-content:center;height:40px;min-width:4em;border-radius:100px;background-color:#fff;color:#000;font-size:24px}#orderDetail .container .container-top .order-title .commit{margin-left:auto;margin-right:12px}#orderDetail .container .container-top .order-title .commit.commited{background-color:#000;color:#fff;border:2px solid #fff}#orderDetail .container .container-top .order-title .time{text-align:right}#orderDetail .container .container-body{display:flex;flex-direction:row;flex-grow:1;flex-shrink:1;width:100%;height:calc(80% - 60px)}#orderDetail .container .container-body .wrap-product-list{display:flex;flex-direction:column;flex-grow:1}#orderDetail .container .container-body .wrap-product-list .product-list{display:flex;flex-direction:column;word-break:keep-all;margin:0;padding:0;overflow:scroll;-webkit-overflow-scrolling:touch}#orderDetail .container .container-body .wrap-product-list .product-list .product-item{word-break:break-all;display:flex;flex-shrink:0;align-items:center;margin-bottom:12px;font-size:48px;font-weight:900}#orderDetail .container .container-body .wrap-product-list .product-list .product-item .count{margin-right:24px;text-align:right}#orderDetail .container .container-body .wrap-product-list .product-list .product-item .first{margin-left:12px;display:flex;align-items:center;justify-content:center;padding:0 24px;border-radius:100px;height:48px;background-color:#fff;color:#000;font-size:24px;font-weight:900}#orderDetail .container .container-body .wrap-order-list{display:flex;flex-direction:column;margin-bottom:24px;flex-shrink:1;flex-grow:1;padding-left:24px;max-width:40%}#orderDetail .container .container-body .wrap-order-list .title{display:flex;flex-shrink:0;align-items:center;justify-content:center;height:40px;font-size:20px;font-weight:700;background-color:#fff;color:#000;border-radius:100px}#orderDetail .container .container-body .wrap-order-list .order-list{flex-grow:1;font-size:20px;display:flex;flex-direction:column;margin:0;padding:0;list-style:none;word-break:keep-all;overflow:scroll;-webkit-overflow-scrolling:touch}#orderDetail .container .container-body .wrap-order-list .order-list .order-item{display:flex;margin:0;padding:8px 0;font-size:20px;align-items:flex-start}#orderDetail .container .container-body .wrap-order-list .order-list .order-item .name{flex-grow:1;word-break:break-all}#orderDetail .container .container-body .wrap-order-list .order-list .order-item .count{margin-left:12px}#orderDetail .container-foot{flex-direction:column;flex-shrink:0}#orderDetail .container-foot,#orderDetail .container-foot .msg{display:flex;align-items:center;justify-content:center;width:100%}#orderDetail .container-foot .msg{font-size:20px;height:60px}#orderDetail .container-foot .buttons{display:flex;align-items:center;justify-content:center;width:100%}#orderDetail .container-foot .buttons .button{margin:0;display:flex;flex-grow:1;align-items:center;justify-content:center;height:80px;border-radius:100px;font-size:32px;font-weight:900;background-color:#fff;color:#202020;margin-left:24px}#orderDetail .container-foot .buttons .button:first-child{margin-left:0}#orderDetail .container-foot .buttons .button-commit{flex-grow:1;background-color:red;color:#fff}", ""]);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.show)?_c('div',{attrs:{"id":"orderDetail"}},[_c('div',{staticClass:"background"}),_c('div',{staticClass:"container"},[_c('div',{staticClass:"container-top"},[_c('div',{staticClass:"order-title"},[_c('div',{staticClass:"table-number"},[_vm._v(_vm._s(_vm.order.table.name))]),_c('div',{staticClass:"msg"},[(_vm.order.products[0].code=='99999')?_c('span',{staticClass:"title"},[_vm._v("호출이요")]):(_vm.order.group.seq==1)?_c('span',{staticClass:"title"},[_vm._v("첫 주문이요")]):_c('span',{staticClass:"title"},[_vm._v("주문이요")])]),(_vm.order.group.seq==1)?_c('div',{staticClass:"first"},[_vm._v("첫 주문")]):_vm._e(),_c('div',{staticClass:"commit",class:{commited:_vm.order.commit.time}},[_vm._v(_vm._s(_vm.order.commit.time ? '확인' : '미확인'))]),_c('div',{staticClass:"time"},[_vm._v(_vm._s(_vm._f("moment")(_vm.order.time,"A hh:mm:ss")))])])]),_c('div',{staticClass:"container-body"},[_c('div',{staticClass:"wrap-product-list"},[_c('ul',{staticClass:"product-list"},_vm._l((_vm.order.products),function(product){return _c('li',{staticClass:"product-item"},[_c('div',{staticClass:"count"},[_vm._v(_vm._s(product.qty)+"개")]),_c('div',{staticClass:"name"},[_vm._v(_vm._s(product.name))]),(product.first)?_c('div',{staticClass:"first"},[_vm._v("첫 주문")]):_vm._e()])}),0)]),(Object.keys(_vm.cumulative_products).length)?_c('div',{staticClass:"wrap-order-list"},[_c('div',{staticClass:"title"},[_vm._v("이전주문내역")]),_c('ul',{staticClass:"order-list"},_vm._l((_vm.cumulative_products),function(product){return _c('li',{staticClass:"order-item"},[_c('div',{staticClass:"name"},[_vm._v(_vm._s(product.name))]),_c('div',{staticClass:"count"},[_vm._v(_vm._s(product.qty)+"개")])])}),0)]):_vm._e()]),_c('div',{staticClass:"container-foot"},[_c('div',{staticClass:"msg"},[_vm._v(_vm._s(_vm.seconds)+"초 후 닫혀요.")]),_c('div',{staticClass:"buttons"},[_c('div',{staticClass:"button button-commit",on:{"click":function($event){return _vm.commitOrder(_vm.order)}}},[_vm._v("확인")]),_c('div',{staticClass:"button button",on:{"click":_vm.closeOrder}},[_vm._v("닫기")])])])])]):_vm._e()}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
