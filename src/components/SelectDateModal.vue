      ...
      .select-date-modal
        .select-date-modal-information
          .select-date-button-list
            button.today(:class="{activeButton: activeButton === 'today'}" @click.stop="pickerSelectToday") 오늘
            button.week(:class="{activeButton: activeButton === 'week'}" @click.stop="pickerSelectWeek") 1주일
            button.month(:class="{activeButton: activeButton === 'month'}" @click.stop="pickerSelectMonth") 1개월
            button.three-month(:class="{activeButton: activeButton === 'three-month'}" @click.stop="pickerSelect3Months") 3개월
          .wrap-start-date
