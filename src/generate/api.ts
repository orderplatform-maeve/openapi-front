...
export const StoreApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteOrder(orderId: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
...
export class StoreApi extends BaseAPI {
     ...
     * @memberof StoreApi
     */
    public deleteOrder(orderId: number, options?: RawAxiosRequestConfig) {
