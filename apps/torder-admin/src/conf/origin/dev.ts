 ...
 */
export default {
  ADMIN_URL: 'https://kr.dev.order.admin.torder.com',
  ...
  MIDDLEWARE_AUTH_TOKEN:
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyTmFtZSI6InRvcmRlciJ9.G5xYgeJ1I6bzr8ErCRgwu_b5WCqCWjCxtsIYBynmVsU',
  GATE_WAY_API_URL: 'https://dev-apigw.torder.com',
